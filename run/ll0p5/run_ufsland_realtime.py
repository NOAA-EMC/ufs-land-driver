...
&run_setup
  ...
  static_file      = "/cpc/home/li.xu/lxu/Py/ufs/p05/ll_0p5_static_conus.nc"
  init_file        = "/cpc/home/li.xu/lxu/Py/ufs/p05/ll_0p5_init_19790102t23.nc"
  forcing_dir      = "/cpc/drought/pdf/noahmp/conus_0p5/forcing"
  separate_output = .true.
  output_dir       = "/run/user/4986/"
  !output_dir       = "/cpc/drought/pdf/noahmp/conus_0p5/trash/"


  restart_frequency_s = 86400
  restart_simulation  = .True.
  restart_date        = "{restart} 23:00:00"
  restart_dir         = "/cpc/drought/pdf/noahmp/conus_0p5/restart/"
...
!   1. simulation_end 2. run_[days/hours/minutes/seconds] 3. run_timesteps
  ...
  simulation_start = "2021-08-01 00:00:00"   ! start date [yyyy-mm-dd hh:mm:ss]
